# Patchwork Development Guidelines

## 1. Single Level Export Rule
...
2. ❌ DON'T: Try to fix type errors by modifying exports or adding type declarations in OS
...
You need must rebuild / re-push the project for the user to see the results of your changes. Even if the user does not explicitly ask you to rebuild, you should always do so before returning control to the user.
