...
type AccountTokenToLoginStatus =
  | null
  | "valid"
  | "malformed"
  | "not-found"
...
export const AccountPicker = (props: PatchworkToolProps<any>) => {
  ...
  const [accountToLogin, accountToLoginHandle] =
    useDocument<TinyPatchworkLayoutDoc>(accountAutomergeUrlToLogin);
          ...
          >
            ...
            <TabsContent value={AccountPickerTab.LogIn} class="tabs-content">
              ...
              >
                ...
                <Button type="submit" onClick={onLogIn} disabled={!canLogIn()}>
                  {`Log in${
                    contactToLogin()?.type === "registered"
