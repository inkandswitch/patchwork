...
describe("subduction server sync", () => {
  it(
    "finds the settings doc with 26 modules",
    async () => {
      ...
      expect(doc.modules!.length).toBe(26);
  ...
  it(
    "finds all 26 folder docs concurrently",
    async () => {
