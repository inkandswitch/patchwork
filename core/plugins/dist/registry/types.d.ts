 ...
 */
export type LoadablePlugin<D extends PluginDescription = PluginDescription, I = any> = D & {
    load: () => Promise<I>;
};
/**
 ...
 */
export type LoadedPlugin<D extends PluginDescription = PluginDescription, I = any> = D & {
    module: I;
};
export type Plugin<D extends PluginDescription = PluginDescription, I = any> = LoadedPlugin<D, I> | LoadablePlugin<D, I>;
