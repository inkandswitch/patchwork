/// This code is taken from the jdsmidgen project: https://github.com/dingram/jsmidgen.
...
(function (exported) {
    ...
    * @param {number} [velocity=90] - The velocity of the chord,
     ...
     * @returns {Track} The current track.
     */
    Track.prototype.addChord = Track.prototype.chord = function (channel, chord, dur, time, velocity) {
