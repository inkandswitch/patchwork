import { ExportMethod as ExportMethodType, dataTypeById } from "@patchwork/sdk";
import { Icon } from "@patchwork/sdk/ui";

export const ExportMethod: React.FC<{ method: ExportMethodType }> = ({
  method,
}) => {
  ...
  return (
    <div className="border rounded p-3">
      <div className="flex items-center gap-2 font-medium mb-2">
        <Icon type="Upload" size={14} />
        <span>Export Method: {method.name}</span>
